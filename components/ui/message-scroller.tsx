...
function MessageScrollerViewport({
  ...
  return (
    <MessageScrollerPrimitive.Viewport
      ...
      className={cn(
        'scroll-fade-b size-full min-h-0 min-w-0 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden overflow-y-auto overscroll-contain contain-content',
        className
      )}
      {...props}
    />
